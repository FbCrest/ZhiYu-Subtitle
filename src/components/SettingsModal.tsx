...
/** Card dạng dashed để thêm model tuỳ chỉnh — click mở portal modal */
              ...
              >
                ...
                >
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      <h5 className="text-sm font-bold text-zinc-500 uppercase tracking-widest mb-2">{t.prompt}</h5>
          ...
          <div className="p-8 h-[70vh] overflow-y-auto scrollbar-thin overflow-x-hidden">
            ...
            {activeTab === 'video' && (
              <div className="flex flex-col items-center justify-center h-full text-zinc-500 space-y-6">
                ...
                <p className="text-zinc-400 text-lg">Feature coming soon...</p>
              </div>
            )}
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                  {AI_MODELS.map((model) => {
                    ...
                    const colorMap: Record<string, {
                      ...
                      indigo: { rgb: '99,102,241',  accent: '#6366f1', badgeCls: 'bg-gradient-to-r from-indigo-500 to-violet-500',  checkCls: 'bg-indigo-500' },
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="relative z-10 space-y-1.5 mt-auto pt-3 border-t border-zinc-800/50">
                          <div className="flex items-center justify-between text-xs font-bold uppercase tracking-wider">
                            <span className="text-zinc-600">Tốc độ:</span>
                            <span className={isSelected ? 'text-white' : 'text-zinc-400'}>{model.speed}</span>
                          </div>
                          <div className="flex items-center justify-between text-xs font-bold uppercase tracking-wider">
                            <span className="text-zinc-600">Độ chính xác:</span>
                            <span className={isSelected ? 'text-white' : 'text-zinc-400'}>{model.accuracy}</span>
                          </div>
                        </div>
                      </div>
                      </div>
                  ...
                  {/* Card thêm model mới — luôn ở cuối cùng */}
                  <AddCustomModelCard
                    onAdd={(id, label, speed, accuracy) => setLocalSettings(prev => ({
                      ...prev,
                      customModels: [...(prev.customModels || []), { id, label, speed, accuracy }]
                    }))}
                  />
                </div>
              </div>
              ...
              <div className="space-y-5 pb-12">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="relative z-10 mt-auto pt-3 border-t border-zinc-800/30 flex justify-center">
                          <span
                            onClick={(e) => { e.stopPropagation(); setIsViewingDetails(template.id); }}
                  ...
                  <button className="flex flex-col items-center justify-center p-8 rounded-[32px] border border-dashed transition-all border-zinc-800 bg-zinc-900/20 hover:bg-zinc-900/40">
                    ...
                    <span className="font-bold text-xs text-zinc-500">{t.addSubtitle}</span>
                  </button>
                </div>

                <div className="space-y-6 pt-4 border-t border-zinc-800/50">
                  <h3 className="text-2xl font-bold">{t.transcriptionPrompt}</h3>
                  <p className="text-zinc-500 text-base leading-relaxed">
                    {t.transcriptionPromptDesc}
                  </p>
